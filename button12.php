        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                  ...
                  <?php
          $del=mysqli_query($mysqli,"select * from register where imageId='".$row['imageId']."'");
          $drow=mysqli_fetch_array($del);
        ?>
                <div class="modal-body">
				<div class="container-fluid">
					<h5><center><strong><?php echo $drow['fname'];  ?> will be deleted from the system</strong></center></h5> 
                </div> 
				</div>
                ...
                <div class="modal-footer">
                    ...
                    <a href="delete1.php?id=<?php echo $row['imageId']; ?>" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                </div>
...
<div class="col-lg-12">
  <div class="modal fade" id="edituser<?php echo $row['imageId']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        ...
        ?>
                      ...
                      <table  class="table table-striped table-hover table-bordered " style="width: 70%" font-size="10px" >
        <div class="container-fluid">
         <form method="POST" class="form-horizontal" action="editmessage.php?id=<?php echo $row['imageId']; ?>" enctype="multipart/form-data">
    ...
    <div class="form-horizontal">
      ...
      <label for="indexnumber" class="col-sm-3 control-label" style="font-size: 0.7vw">Message:</label>
       <div class="col-sm-9">
        <textarea class="form-control input-sm" name="message" placeholder="type message here">
        </textarea>
       </div>
    </div>   
         <div class="col-sm-5 col-md-push-3"  style="background-color: ">
