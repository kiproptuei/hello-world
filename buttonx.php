    ...
    <div class="modal fade" id="del<?php echo $row['imageId']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        ?>
                ...
                <div class="modal-footer">
                    ...
                    <a href="deletex.php?id=<?php echo $row['imageId']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                </div>
...
<div class="col-lg-12">
	<div class="modal fade" id="edit<?php echo $row['imageId']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        ?>
				...
				<div class="container-fluid">
				 <form method="POST" class="form-horizontal" action="editx.php?id=<?php echo $row['imageId']; ?>" enctype="multipart/form-data">
