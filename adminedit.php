...
//        $description = $_POST['description'];
...

    {
      ...
      if(!isset($errMSG))
    {
 $sql="insert into product_detail(imageType ,imageData,serialNo,productType,brand,specification,price,status,username) values('{$imageProperties['mime']}', '$imgData','$serialNo','$productType','$brand','$specification','$price','$status','$username')";
...
<body style="background-color: pink">
  <div class="wrapper" style="background-color: white">
     ...
     // $brand = $_SESSION['brand'];
        $query=mysqli_query($mysqli,"SELECT * from products where status='onsale' ORDER BY imageId DESC");
        while($row=mysqli_fetch_array($query)){
          ?>
          <tr >
                      <td>  <a href="#" >
     ...
     <td style="text-align:center; word-break:break-all; width:200px;">  <?php echo $row ['serialNo']; ?></td>
             ...
             <td style="text-align:center; word-break:break-all; width:200px;font-size: 0.8vw;">  <?php echo $row ['description']; ?></td>
                              <td style="text-align:center; word-break:break-all; width:150px;font-size: 0.8vw;">  <?php echo $row ['price']; ?></td>
